...
newCardioid loc point   = Vardioid {location = loc, pointing = normalize point, coeff = 0.5}

newBipolar :: Vec3 Double -> Vec3 Double -> Vardioid
newBipolar loc point    = Vardioid {location = loc, pointing = normalize point, coeff = 1}
